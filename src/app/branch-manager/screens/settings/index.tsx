...
function initials(firstName: string, lastName: string): string {
  return `${firstName.charAt(0)}${lastName.charAt(0)}`.toUpperCase() || 'BM';
}
...
/** Self-service profile controls for the authenticated, branch-scoped Branch Manager. */
export default function BranchManagerAccountSettings() {
  ...
  // Apply fetched profile data to form whenever the query result changes.
  useEffect(() => {
  ...
  return (
    <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-10 lg:grid-cols-[220px_minmax(0,1fr)]">
          <aside className="flex flex-col items-center pt-2 text-center">
            ...
            <h2 className="mt-5 text-xl font-semibold leading-tight text-gray-900">
              {form.firstName || 'Branch'}{' '}
              <span className="block">{form.lastName || 'Manager'}</span>
            </h2>
          ...
          <section aria-labelledby="bm-personal-details-heading">
            <h2 id="bm-personal-details-heading" className="text-xl font-semibold text-gray-900">
              Personal details
            </h2>
      ...
      <section className="flex items-center justify-between gap-6 py-7" aria-labelledby="bm-security-password-heading">
        <div className="flex min-w-0 items-center gap-4">
          ...
          <div className="min-w-0">
            <h2 id="bm-security-password-heading" className="whitespace-nowrap text-lg font-semibold text-gray-900">
              Security Password
            </h2>
      ...
      {passwordOpen && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 p-4" role="presentation">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl" role="dialog" aria-modal="true" aria-labelledby="bm-change-password-title">
            <h2 id="bm-change-password-title" className="text-lg font-semibold text-gray-900">Change password</h2>
