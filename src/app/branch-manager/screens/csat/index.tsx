...
/**
 * CSAT Feedback & Analytics — the Branch Manager's closed-loop follow-up on
 * low-rated deliveries (journey BM-US-08). Lists flagged 1–3 star deliveries
 * (BM-038), lets the BM review the associated service request inline (BM-039),
 * and log a resolution note that marks the complaint addressed (BM-040/041).
 */
