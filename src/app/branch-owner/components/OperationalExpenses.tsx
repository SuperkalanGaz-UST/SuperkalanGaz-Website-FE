          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <ResponsiveContainer width="100%" height={340}>
              <BarChart data={barChartData} margin={{ top: 4, right: 4, left: 0, bottom: 25 }}>
                ...
                <Tooltip
                  // `any` reason: recharts' Tooltip generics can't unify the
                  // NameType inferred from formatter's tuple with labelFormatter's payload.
                  labelFormatter={(_, payload: any[]) => payload?.[0]?.payload?.category?.replace('\n', ' ') ?? ''}
