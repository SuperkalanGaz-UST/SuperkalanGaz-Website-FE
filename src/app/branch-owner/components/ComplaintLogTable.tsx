        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="text-left text-xs font-semibold text-gray-700 pb-3">Complaint ID</th>
              <th className="text-left text-xs font-semibold text-gray-700 pb-3">Customer Name</th>
              <th className="text-left text-xs font-semibold text-gray-700 pb-3">Issue Summary</th>
              <th className="text-left text-xs font-semibold text-gray-700 pb-3">Status</th>
              <th className="text-left text-xs font-semibold text-gray-700 pb-3">Response Time</th>
            </tr>
          </thead>
          <tbody>
