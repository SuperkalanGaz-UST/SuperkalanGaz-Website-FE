            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left text-xs font-semibold text-gray-700 pb-3">Redemption Date</th>
                  <th className="text-left text-xs font-semibold text-gray-700 pb-3">Approved By</th>
